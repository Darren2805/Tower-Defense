...
void SettingsScene::Initialize()
{
    ...
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", halfW - 200, h - 200, 400, 100);
    btn->SetOnClickCallback(std::bind(&SettingsScene::StartOnClick, this));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("BACK", "pirulen.ttf", 48, halfW, h - 150, 0, 0, 0, 255, 0.5, 0.5));
